...
*Lưu ý: Script sẽ tự động tạo môi trường ảo (venv) và cài đặt mọi thứ cần thiết.*

## ⚙️ Cấu hình (Onboarding)

Sau khi cài đặt, hãy kích hoạt môi trường ảo:
- macOS/Ubuntu: `source venv/bin/activate`
- Windows: `venv\Scripts\activate`

Lần đầu chạy tool bằng lệnh `blog-autogen`, hệ thống sẽ yêu cầu bạn nhập các thông tin cấu hình:
...
Đảm bảo bạn đã kích hoạt môi trường ảo (`venv`), sau đó chuẩn bị danh sách chủ đề hoặc prompt vào file `prompts.txt` (mỗi dòng một prompt).
